...
parameters = {"ingredients": "tomato, mushroom,beef",
              "preferences": "healthy"}
...
if st.button("Let's get some recipes!"):
    ...
    get_recipes_expand(request_recipes(parameters))
else:
    pass
